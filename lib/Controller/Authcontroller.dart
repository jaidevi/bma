...
import 'package:sampleproj/Providerregisterview/main.dart';
...
class Authcontroller extends GetxController {
  ...
  changeLanguage(String selectedLanguage) {
    switch (selectedLanguage) {
      case 'aadharcard':
        Get.updateLocale(Locale('aadharcard'));
        print('Changed to En');
        break;
      case 'pancard':
        Get.updateLocale(Locale('pancard'));
        print('Changed to Es');
        break;

      case 'voterid':
        Get.updateLocale(Locale('voterid'));
        print('Changed to Es');
        break;
      case 'drivinglicense':
        Get.updateLocale(Locale('drivinglicense'));
        print('Changed to Es');
        break;
      default:
        Get.updateLocale(Locale('aadharcard'));
  ...
  changeLanguage1(String selectedLanguage1) {
    switch (selectedLanguage1) {
      case 'tanker':
        Get.updateLocale(Locale('Tanker'));
        print('Changed to En');
        break;
      case 'cans':
        Get.updateLocale(Locale('cans'));
        print('Changed to Es');
        break;
  ...
  changeImage(String? selectedImage1) {
    switch (selectedImage1) {
      case 'camera':
        Get.updateLocale(Locale('camera'));
        print('Changed to pn');
        break;
      case 'gallery':
        Get.updateLocale(Locale('gallery'));
        print('Changed to ln');
        break;
      default:
        Get.updateLocale(Locale('camera'));
  ...
  Future<void> providersignup({
    ...
    final response = await post(
      Uri.parse('http://192.168.1.18:8080/api/provider/signup'),
